...
- `public/` — static files served as-is at `/...` (`assets/image/`, `assets/pdf/`, `assets/cv/`, `assets/presentations/`, favicon).
...
- **GitHub Pages size caveat**: `public/assets/pdf` is about 881 MB, against GitHub Pages' 1 GB per-site limit — be mindful of this when adding large PDFs (posters, theses).
